 ...
 * class is mostly focused to verify that a correct behavior when managing white
 * lists and permission for that.
 */
@NotThreadSafe
...
public class ITVerifyWhitelistManagement {
  ...
  public static void beforeClass() throws Exception {
    ...
    session.execute("GRANT SELECT ON TABLE ecks_itvwm.ectbl TO ordinary_user");
  ...
  public void testAuthorizedUserCanGrantWhitelistToHimself() {
    ...
    assertRoleOperations(
        ...
        asList("CREATE", "ALTER", "DROP", "SELECT", "MODIFY", "AUTHORIZE"));
  }
  ...
  public void testSuperUserCanWhitelistOnRoles() {
    ...
    assertRoleOperations(
        ...
        asList("CREATE", "ALTER", "AUTHORIZE", "DESCRIBE", "DROP"));
  }
  ...
  public void testTrustedUserCanDelegateWhitelistedRole() {
    try (CqlSession privateSession =
             cdt.createSession("trusted_user", "secret")) {
      given_temporary_user(privateSession);
  ...
  private void assertRoleOperations(String roleName, String resource,
                                    List<String> expectedOperations) {
    ResultSet result = superSession.execute("LIST ROLES OF " + roleName);
    Map<String, String> optionsMap =
        result.one().getMap("options", String.class, String.class);
    ...
    List<String> operations =
        Splitter.on(",").trimResults().splitToList(operationsString);
