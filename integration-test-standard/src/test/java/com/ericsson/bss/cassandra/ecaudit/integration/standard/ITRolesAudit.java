...
public class ITRolesAudit {
  ...
  private Object[] parametersForRoleStatements() {
    return new Object[] {
        ...
        new Object[] {"ALTER ROLE " + USER + " WITH LOGIN = false", "alter",
                      "roles/" + USER},
        new Object[] {"GRANT " + ROLE + " TO " + USER, "authorize",
                      "roles/" + ROLE},
        new Object[] {"REVOKE " + ROLE + " FROM " + USER, "authorize",
                      "roles/" + ROLE},
  ...
  public void systemStatementsAreNotLoggedWithGrantBasedAudit() {
    ...
    ccf.givenRoleIsWhitelistedForOperationOnResource(GRANT_BASED_USER, "ALL",
                                                     "grants/data");
